"""
Django settings for canigo project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '%s^n5efw3b2%keiyvtrc1l6dg4eg1kg=e&3_(s2p2*h7ao)c7e')
...
WSGI_APPLICATION = 'canigo.wsgi.application'
